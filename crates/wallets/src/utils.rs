use crate::{PendingSigner, WalletSigner, error::WalletSignerError, error::PrivateKeyError};
...
pub async fn create_ledger_signer(
    ...
    Err(WalletSignerError::UnsupportedSigner("Ledger").into())
}
...
pub async fn create_trezor_signer(
    ...
    Err(WalletSignerError::UnsupportedSigner("Trezor").into())
}
...
mod tests {
    ...
    #[tokio::test]
    async fn parse_private_key_signer() {
        let pk = B256::random();
