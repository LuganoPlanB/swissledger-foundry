        ...
        dispatch_call(
            ...
            |call| match call {
                ...
                IValidatorConfigCalls::setNextFullDkgCeremony(call) => {
                    mutate_void(call, msg_sender, |s, c| self.set_next_full_dkg_ceremony(s, c))
                }
            },
        )
    }
...
mod tests {
    ...
    fn test_change_validator_status_by_index_t1_gating() -> eyre::Result<()> {
        ...
        StorageCtx::enter(&mut storage, || -> eyre::Result<()> {
            ...
            let call =
                IValidatorConfig::changeValidatorStatusByIndexCall { index: 0, active: false };
        ...
        StorageCtx::enter(&mut storage, || -> eyre::Result<()> {
            ...
            assert!(!result.is_revert(), "changeValidatorStatusByIndex should succeed in T1");
