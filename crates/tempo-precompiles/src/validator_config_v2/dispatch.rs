...
impl Precompile for ValidatorConfigV2 {
    fn call(&mut self, calldata: &[u8], msg_sender: Address) -> PrecompileResult {
        ...
        dispatch_call(calldata, &[], IValidatorConfigV2Calls::abi_decode, |call| match call {
            ...
            IValidatorConfigV2Calls::transferValidatorOwnership(call) => {
                mutate_void(call, msg_sender, |s, c| self.transfer_validator_ownership(s, c))
            }
            ...
            IValidatorConfigV2Calls::setNetworkIdentityRotationEpoch(call) => {
                mutate_void(call, msg_sender, |s, c| self.set_network_identity_rotation_epoch(s, c))
            }
