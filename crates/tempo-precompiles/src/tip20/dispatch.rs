...
mod tests {
    ...
    fn test_change_transfer_policy_id() -> eyre::Result<()> {
        ...
        StorageCtx::enter(&mut storage, || {
            ...
            let change_policy_call =
                ITIP20::changeTransferPolicyIdCall { newPolicyId: another_policy_id };
            let calldata = change_policy_call.abi_encode();
    ...
    fn test_call_uninitialized_token_reverts() -> eyre::Result<()> {
        ...
        StorageCtx::enter(&mut storage, || {
            ...
            let calldata =
                ITIP20::approveCall { spender: Address::random(), amount: U256::random() }
                    .abi_encode();
            let result = token.call(&calldata, caller)?;
    ...
    fn test_permit_selectors_gated_behind_t2() -> eyre::Result<()> {
        ...
        StorageCtx::enter(&mut storage, || {
            ...
            let nonces_calldata = ITIP20::noncesCall { owner: Address::random() }.abi_encode();
